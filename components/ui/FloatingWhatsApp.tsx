...
export default function FloatingWhatsApp() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-40">
            ...
            <div
                className={`absolute bottom-full right-0 mb-2 bg-gray-900 text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap transition-all duration-200 ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none'
                    }`}
            >
                Chat on WhatsApp
